...
(function(window, document, undefined) {
     ...
     * ```
     */
    var domPrefixes = (ModernizrProto._config.usePrefixes ? omPrefixes.toLowerCase()
        .split(' ') : []);
    ...
    var mq = (function() {
        ...
        return function(mq) {
            ...
            injectElementWithStyles('@media ' + mq + ' { #modernizr { position: absolute; } }', function(node) {
                bool = (window.getComputedStyle ? window.getComputedStyle(node, null) : node.currentStyle)
                    .position == 'absolute';
            });
            return bool;
        };
...
(function(global, factory) {
                ...
                filter: {
                    ...
                    "ATTR": function(name, operator, check) {
                        return function(elem) {
                            ...
                            result += "";
                            return operator === "=" ? result === check : operator === "!=" ? result !== check : operator === "^=" ? check && result.indexOf(check) === 0 : operator === "*=" ? check && result.indexOf(check) > -1 : operator === "$=" ? check && result.slice(-check.length) === check : operator === "~=" ? (" " + result.replace(rwhitespace, " ") + " ")
            ...
            select = Sizzle.select = function(selector, context, results, seed) {
                ...
                if (match.length === 1) {
                    ...
                    if (tokens.length > 2 && (token = tokens[0])
                        .type === "ID" && context.nodeType === 9 && documentIsHTML && Expr.relative[tokens[1].type]) {
                    ...
                    if (cur.nodeType === 1 && !(event.type === "click" && cur.disabled === true)) {
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matchedSelectors[sel] === undefined) {
                                matchedSelectors[sel] = handleObj.needsContext ? jQuery(sel, this)
                ...
                if (computed) {
                    ...
                    return rdisplayswap.test(jQuery.css(elem, "display")) &&
                        ...
                        (!elem.getClientRects()
                            ...
                            .width) ? swap(elem, cssShow, function() {
    ...
    jQuery.cssHooks.marginLeft = addGetHookIf(support.reliableMarginLeft, function(elem, computed) {
        if (computed) {
            return (parseFloat(curCSS(elem, "marginLeft")) || elem.getBoundingClientRect()
                .left - swap(elem, {
                    marginLeft: 0
                }, function() {
    ...
    jQuery.each(("blur focus focusin focusout resize scroll click dblclick " + "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave " + "change select submit keydown keypress keyup contextmenu")
        .split(" "),
        function(i, name) {
...
(function() {
     ...
     * @type boolean
     */
    var deviceIsIOS4 = deviceIsIOS && (/OS 4_\d(_\d)?/)
     ...
     * @type boolean
     */
    var deviceIsIOSWithBadTarget = deviceIsIOS && (/OS [6-7]_\d/)
        .test(navigator.userAgent);
    /**
